export interface CountryCode {
  ...
  // Helper function to extract numeric value from country code for sorting
  const getCodeNumericValue = (code: string): number => {
    // Remove the '+' and extract the main numeric part (before dash if exists)
    const mainCode = code.replace('+', '').split('-')[0];
    return parseInt(mainCode, 10) || 0;
  };
  
  const unsortedCountryCodes: CountryCode[] = [
    ...
    { flag: "🇦🇮", code: "+1-264", name: "Anguilla", iso: "AI" },
    { flag: "🇦🇬", code: "+1-268", name: "Antigua & Barbuda", iso: "AG" },
    ...
    { flag: "🇧🇦", code: "+387", name: "Bosnia & Herzegovina", iso: "BA" },
    ...
    { flag: "🇨🇩", code: "+243", name: "Congo (DRC)", iso: "CD" },
    ...
    { flag: "🇨🇿", code: "+420", name: "Czech Republic", iso: "CZ" },
    ...
    { flag: "🇲🇴", code: "+853", name: "Macau", iso: "MO" },
    ...
    { flag: "🇸🇹", code: "+239", name: "Sao Tome & Principe", iso: "ST" },
    ...
    { flag: "🇹🇹", code: "+1-868", name: "Trinidad & Tobago", iso: "TT" },
    ...
    { flag: "🇻🇦", code: "+379", name: "Vatican City", iso: "VA" },
  ...
  // Sort by numeric value of country code
  export const countryCodes: CountryCode[] = unsortedCountryCodes.sort((a, b) => {
    const numA = getCodeNumericValue(a.code);
    const numB = getCodeNumericValue(b.code);
    if (numA !== numB) {
      return numA - numB;
    }
    // If main codes are equal, sort by full code string
