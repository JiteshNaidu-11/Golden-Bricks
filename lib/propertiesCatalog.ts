...
// ============================================
const PLATINUM_PROPERTIES: CatalogProperty[] = [
  {
  ...
  },
  {
    ...
    image: "/properties/one-platinum.jpg",
    builder: "Platinum Group",
  ...
  },
  {
    ...
    location: "Nerul, Navi Mumbai",
    price: "Price on Request",
    bhk: "2 & 3 BHK Ultra-Luxury Residences",
  ...
  },
  {
    ...
    name: "Platinum Praksyde",
    location: "Kharghar, Navi Mumbai",
    price: "Price on Request",
    bhk: "2 & 3.5 BHK Premium Residences",
...
// ============================================
const OTHER_PROPERTIES: CatalogProperty[] = [
  {
...
Connect with Golden Brix for layouts, availability, and investment options.`,
  ...
  },
  {
    ...
    location: "Palm Beach Road, Nerul, Navi Mumbai",
    price: "Price on Request",
    bhk: "2.5, 3 & 4 BHK Uber Luxury Residences",
    image: "https://sunitarealestate.com/wp-content/uploads/2026/01/9-pbr.jpg",
    builder: "Adani Realty & Mistry Construction",
    propertyType: "Residential",
    possession: "Under Construction",
  ...
  },
  {
    ...
    builder: "Reputed Developer",
    propertyType: "Commercial",
    possession: "Under Construction",
    overview: `24 HIGH is a premium commercial development offering modern office spaces designed for growing businesses and enterprises. Strategically located in Navi Mumbai, it ensures excellent connectivity, high visibility, and strong investment potential.`,
    highlights: [
      "Prime commercial location",
      "High-rise business tower",
...
// ============================================
// COMBINED CATALOG: PLATINUM FIRST, THEN OTHERS
// ============================================
